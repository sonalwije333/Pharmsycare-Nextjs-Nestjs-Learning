...
export class Order extends CoreEntity {
  ...
  @Column({ type: 'varchar', nullable: true, default: FulfillmentType.DELIVERY })
  delivery_method: FulfillmentType;

  @ApiProperty({
    description: 'Pickup location (when delivery_method is pickup)',
    example: 'Sethma Pharmacy - Main Branch',
    required: false,
  })
  @Column({ type: 'varchar', nullable: true })
