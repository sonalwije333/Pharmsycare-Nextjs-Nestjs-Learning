...
export class Order extends CoreEntity {
  ...
  // @ApiProperty({ description: 'Customer', type: () => User }) // Commented for future use
  // customer: any;
  ...
  @ApiProperty({ description: 'Coupon', type: () => Coupon }) // Commented for future use
  coupon?: any;
  ...
  // @ApiProperty({ description: 'Products', type: [Product] }) // Commented for future use
  // products?: any[];

  // @ApiProperty({ description: 'Billing address', type: () => UserAddress }) // Commented for future use
  // billing_address?: any;

  // @ApiProperty({ description: 'Shipping address', type: () => UserAddress }) // Commented for future use
...
export class OrderFiles extends CoreEntity {
  ...
  // @ApiProperty({ description: 'File', type: () => File }) // Commented for future use
  // file?: any;

  // @ApiProperty({ description: 'Fileable product', type: () => Product }) // Commented for future use
  // fileable?: any;
}