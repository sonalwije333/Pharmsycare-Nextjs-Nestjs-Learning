...
export class QuestionSeederService {
  ...
  async seed(): Promise<void> {
    ...
    try {
      ...
      // PharmSy-Care is a pharmacy with a single Medicine shop. All seeded
      // questions are attributed to that shop.
      const medicineShopRows = await this.questionRepository.manager.query(
      ...
      for (const questionData of questionsData) {
        ...
        if (!existingQuestion) {
          const question = this.questionRepository.create({
            ...
            shop_id: medicineShopId ?? questionData.shop_id,
