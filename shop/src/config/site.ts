...
export const siteSettings = {
  ...
  authorizedLinks: [
    ...
    { href: Routes.prescriptions, label: 'auth-menu-my-prescriptions' },
    { href: Routes.uploadPrescription, label: 'nav-menu-upload-prescription' },
  ...
  dashboardSidebarMenu: [
    ...
    },
    {
      ...
      label: 'profile-sidebar-my-prescriptions',
    },
    {
