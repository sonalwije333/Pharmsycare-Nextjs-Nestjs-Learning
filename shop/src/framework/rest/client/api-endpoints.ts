export const API_ENDPOINTS = {
  ...
  USERS_FORGOT_PASSWORD: '/auth/forget-password',
  USERS_VERIFY_FORGOT_PASSWORD_TOKEN: '/auth/verify-forget-password',
  ...
  SEND_VERIFICATION_EMAIL: '/auth/email/verification-notification',
  ...
  SUPPORT_TICKETS_MY: '/support-tickets/my',
