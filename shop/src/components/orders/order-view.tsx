    ...
    <div className="p-4 sm:p-8">
      <div className="mx-auto w-full max-w-screen-lg">
        <div className="mb-5 flex items-center justify-between gap-4">
          ...
          <button
            type="button"
            onClick={() => printElement(receiptRef.current, 'Order Receipt')}
            className="inline-flex items-center gap-2 rounded border border-accent bg-accent px-4 py-2 text-sm font-semibold text-white transition hover:bg-accent-hover"
          >
        ...
        <div style={{ display: 'none' }} aria-hidden="true">
          <OrderReceipt ref={receiptRef} order={order} settings={settings} />
        </div>
