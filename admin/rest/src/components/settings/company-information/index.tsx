    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-wrap pb-8 my-5 border-b border-gray-300 border-dashed sm:my-8 sm:mt-8 sm:mb-3">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          ...
          />
          <PhoneNumberInput
            label="Pharmacist WhatsApp Number"
            toolTipText="WhatsApp number used for the storefront chat-with-pharmacist button"
            {...register('contactDetails.pharmacistWhatsApp')}
            control={control}
            error={t(errors.contactDetails?.pharmacistWhatsApp?.message!)}
          />
          <Input
