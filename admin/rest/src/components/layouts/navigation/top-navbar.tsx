...
import { CreateOrderIcon } from '@/components/icons/sidebar';
...
import InventoryAlertBar from '@/components/layouts/topbar/inventory-alert-bar';
          ...
          <div className="flex shrink-0 grow-0 basis-auto items-center">
            {hasAccess(adminOwnerAndStaffOnly, permissions) && (
              <div className="px-2 sm:px-4">
                ...
                >
                  <CreateOrderIcon className="h-4 w-4" />
                  <span>POS</span>
                </LinkButton>
              </div>
            )}
            ...
            {hasAccess(adminOwnerAndStaffOnly, permissions) ? (
              <div className="flex items-center gap-3 px-0.5 py-3 sm:relative sm:border-gray-200/80 sm:py-3.5 sm:px-4 sm:border-s lg:py-5 lg:px-6">
                <InventoryAlertBar
                  shopId={shop?.id}
                  shopSlug={query?.shop as string}
                />
              </div>
            ) : null}
          </div>
