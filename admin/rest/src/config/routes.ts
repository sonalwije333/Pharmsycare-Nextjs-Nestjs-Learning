export const Routes = {
  ...
  expiryAlerts: '/products/expiry-alerts',
  ...
  supplierList: '/users/suppliers',
  supplierCreate: '/users/suppliers/create',
  supplierPerformance: '/users/suppliers/performance',
  reorderRequests: '/reorder-requests',
  ...
  branches: '/branches',
  branchAvailability: '/branches/availability',
  branchInventory: '/branches/inventory',
  branchCoordination: '/branches/coordination',
  ...
  visitStore: (slug: string) => {
    ...
    return normalizedSlug ? `${shopUrl}/${normalizedSlug}` : shopUrl;
  },
