    ...
    admin: {
        ...
        childMenu: [
          {
            ...
            childMenu: [
              ...
              {
                href: Routes.expiryAlerts,
                label: 'Drug Expiry Alerts',
                icon: 'ProductsIcon',
              },
            ],
          },
      ...
      supplierManagement: {
        ...
        childMenu: [
          ...
          {
            href: Routes.supplierPerformance,
            label: 'Supplier Performance',
            icon: 'PerformanceIcon',
          },
          {
            href: Routes.stockMonitoring,
          ...
          {
            href: Routes.procurementHistory,
        ...
        childMenu: [
          {
            ...
            childMenu: [
              ...
              {
                href: (shop: string) => `/${shop}${Routes.expiryAlerts}`,
                label: 'Drug Expiry Alerts',
                icon: 'ProductsIcon',
                permissions: adminOwnerAndStaffOnly,
              },
