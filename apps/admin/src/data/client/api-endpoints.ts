export const API_ENDPOINTS = {
  ...
  ME: 'v1/auth/me',
  TOKEN: 'v1/auth/login',
  BLOCK_USER: 'v1/users/block-user',
  UNBLOCK_USER: 'v1/users/unblock-user',
  CHANGE_PASSWORD: '/v1/auth/change-password',
  FORGET_PASSWORD: '/v1/auth/forget-password',
  VERIFY_FORGET_PASSWORD_TOKEN: '/v1/auth/verify-forget-password-token',
  ...
  ADD_WALLET_POINTS: 'v1/auth/add-points',
  ...
  MAKE_ADMIN: 'v1/users/make-admin',
  AUTHORS: 'authors',
  ...
  VENDORS_LIST: 'v1/vendors/list',
  CUSTOMERS: 'v1/customers/list',
  ...
  MY_STAFFS: 'v1/my-staffs',
  ALL_STAFFS: 'v1/all-staffs',
